...
export default function CalendarGrid({ 
  ...
  return (
    <>
      ...
      <div className="flex-1 flex flex-col min-h-0 bg-workspace-sidebar border border-workspace-border rounded-xl overflow-hidden">
        ...
        <div className="flex-1 grid grid-cols-7 grid-rows-[repeat(auto-fit,minmax(0,1fr))] auto-rows-[1fr]">
